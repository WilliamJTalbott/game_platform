...
var Client = /** @class */ (function () {
    ...
    Client.prototype.makeNotice = function (noticeable, name, extra) {
        if (name === void 0) { name = undefined; }
        if (extra === void 0) { extra = undefined; }
        var notice = (0, util_1$5.makeNotice)(noticeable);
        if (name && !(typeof name === 'object')) {
            var n = String(name);
            name = { name: n };
        }
        if (name) {
            notice = (0, util_1$5.mergeNotice)(notice, name);
        }
        if (typeof extra === 'object' && extra !== null) {
            notice = (0, util_1$5.mergeNotice)(notice, extra);
        }
        if ((0, util_1$5.objectIsEmpty)(notice)) {
            return null;
        }
        ...
        notice = (0, util_1$5.merge)(notice, {
            name: notice.name || 'Error',
            context: (0, util_1$5.merge)(context, notice.context),
        ...
        if (!Array.isArray(notice.backtrace) || !notice.backtrace.length) {
            if (typeof notice.stack !== 'string' || !notice.stack.trim()) {
                notice.stack = (0, util_1$5.generateStackTrace)();
                notice.backtrace = (0, util_1$5.makeBacktrace)(notice.stack, true, this.logger);
            }
            else {
                notice.backtrace = (0, util_1$5.makeBacktrace)(notice.stack, false, this.logger);
            }
        }
        return notice;
    };
    Client.prototype.addBreadcrumb = function (message, opts) {
        ...
        opts = opts || {};
        var metadata = (0, util_1$5.shallowClone)(opts.metadata);
    ...
    Client.prototype.logEvent = function (data) {
        (0, util_1$5.logDeprecatedMethod)(this.logger, 'Honeybadger.logEvent', 'Honeybadger.event');
        this.event('log', data);
    };
    ...
    Client.prototype.__buildPayload = function (notice) {
        var headers = (0, util_1$5.filter)(notice.headers, this.config.filters) || {};
        var cgiData = (0, util_1$5.filter)(__assign$1(__assign$1({}, notice.cgiData), (0, util_1$5.formatCGIData)(headers, 'HTTP_')), this.config.filters);
        return {
            ...
            error: {
                ...
                tags: notice.tags,
                causes: (0, util_1$5.getCauses)(notice, this.logger),
            },
            request: {
                url: (0, util_1$5.filterUrl)(notice.url, this.config.filters),
                component: notice.component,
                action: notice.action,
                context: notice.context,
                cgi_data: cgiData,
                params: (0, util_1$5.filter)(notice.params, this.config.filters) || {},
                session: (0, util_1$5.filter)(notice.session, this.config.filters) || {}
            },
            server: {
    ...
    Client.prototype.__runPreconditions = function (notice) {
        ...
        var beforeNotifyResult = (0, util_1$5.runBeforeNotifyHandlers)(notice, this.__beforeNotifyHandlers);
        ...
        return (0, util_1$5.getSourceForBacktrace)(originalBacktrace, this.__getSourceFileHandler)
            ...
            return __generator$3(this, function (_a) {
                ...
                return [2 /*return*/, this.__transport
                        ...
                        method: 'POST',
                        endpoint: (0, util_1$5.endpoint)(this.config.endpoint, '/v1/notices/js'),
                        maxObjectDepth: this.config.maxObjectDepth,
                        logger: this.logger,
                    }, payload)];
            });
            ...
            if (res.statusCode !== 201) {
                (0, util_1$5.runAfterNotifyHandlers)(notice, _this.__afterNotifyHandlers, new Error("Bad HTTP response: ".concat(res.statusCode)));
            ...
            (0, util_1$5.runAfterNotifyHandlers)(notice, _this.__afterNotifyHandlers, err);
            return false;
        });
    };
    return Client;
...
util.readConfigFromFileSystem = util.getSourceFile = util.getStats = util.fatallyLogAndExit = util.fatallyLogAndExitGracefully = void 0;
var os_1 = __importDefault$4(require$$0__default["default"]);
var fs_1 = __importDefault$4(require$$1__default["default"]);
var path_1 = __importDefault$4(require$$2__default["default"]);
var util_1$4 = require$$3__default["default"];
var readFile = (0, util_1$4.promisify)(fs_1.default.readFile);
function fatallyLogAndExitGracefully(signal) {
    console.log("[Honeybadger] Received ".concat(signal, ", exiting immediately"));
    process.exit();
}
util.fatallyLogAndExitGracefully = fatallyLogAndExitGracefully;
function fatallyLogAndExit(err, source) {
    console.error("[Honeybadger] Exiting process due to ".concat(source));
        ...
        var honeybadgerUncaughtExceptionListener = function (uncaughtError) {
            ...
            if (_this.__handlerAlreadyCalled) {
                if (!_this.hasOtherUncaughtExceptionListeners()) {
                    (0, util_1$3.fatallyLogAndExit)(uncaughtError, 'uncaught exception');
                }
                return;
            }
...
uncaught_exception_plugin.default = default_1$2;
            ...
            _this.__client.notify(reason, { component: 'unhandledRejection' }, {
                afterNotify: function () {
                    ...
                    if (!_this.hasOtherUnhandledRejectionListeners()) {
                        (0, util_1$2.fatallyLogAndExit)(reason, 'unhandled rejection');
                    }
                }
            });
        };
...
unhandled_rejection_plugin.default = default_1$1;
...
Object.defineProperty(shutdown_monitor, "__esModule", { value: true });
var util_1$1 = util;
var ShutdownMonitor = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!this.hasOtherShutdownListeners(signal)) {
                            (0, util_1$1.fatallyLogAndExitGracefully)(signal);
                        }
                        return [2 /*return*/];
                }
            });
    ...
    ShutdownMonitor.KILL_SIGNALS = ['SIGTERM', 'SIGINT'];
    return ShutdownMonitor;
}());
shutdown_monitor.default = ShutdownMonitor;

var __importDefault$1 = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(shutdown_plugin, "__esModule", { value: true });
var shutdown_monitor_1 = __importDefault$1(shutdown_monitor);
var shutdownMonitor = new shutdown_monitor_1.default();
function default_1() {
    return {
        load: function (client) {
...
shutdown_plugin.default = default_1;
...
(function (exports) {
	...
	var shutdown_plugin_1 = __importDefault(shutdown_plugin);
